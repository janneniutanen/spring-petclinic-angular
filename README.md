...
# Setting the REST API URL in the build
In order to set the REST_API_URL, set an environment variable `REST_API_URL`and run either `npm install` or `npm run create-env`, then run `ng build --prod`.
